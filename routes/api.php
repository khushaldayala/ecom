...
Route::group(array('prefix' => 'v1'), function () {
    ...
    Route::middleware(['auth:sanctum'])->group(function () {
        Route::controller(BannerController::class)->group(function () {
            ...
            Route::delete('delete_banner/{banner}', 'delete')->name('delete_banner');
            Route::delete('trash_delete_banner/{banner}', 'trash_delete')->name('trash_delete_banner');
            Route::get('trash_delete_all_banner', 'all_trash_delete')->name('trash_delete_all_banner');
            Route::get('trash_restore_banner/{banner}', 'trash_restore')->name('trash_restore_banner');
            Route::get('get_single_banner/{banner}', 'get_single_banner')->name('get_single_banner');
            Route::post('update_banner/{banner}', 'update')->name('update_banner');
            ...
            Route::put('banner_status_update/{banner}', 'statusUpdate')->name('banner_status_update');
        });
        ...
        Route::controller(AdvertiseController::class)->group(function () {
            ...
            Route::post('update_advertise/{advertise}', 'update')->name('update_advertise');
            Route::get('get_single_advertise/{advertise}', 'get_single_advertise')->name('get_single_advertise');
            Route::delete('delete_advertise/{advertise}', 'delete')->name('delete_advertise');
            Route::get('trash_advertise', 'trash_advertise')->name('trash_advertise');
            Route::get('trash_advertise_restore/{advertise}', 'trash_advertise_restore')->name('trash_advertise_restore');
            Route::delete('trash_advertise_delete/{advertise}', 'trash_advertise_delete')->name('trash_advertise_delete');
        ...
        Route::controller(AttributeController::class)->group(function () {
            ...
            Route::post('attribute_store', 'store')->name('attribute_store');
            Route::post('update_attribute/{attribute}', 'update')->name('update_attribute');
            Route::get('get_single_attribute/{attribute}', 'get_single_filter')->name('get_single_attribute');
            Route::delete('delete_attribute/{attribute}', 'delete')->name('delete_attribute');
            Route::get('trash_attributes', 'trash_filter')->name('trash_attributes');
        ...
        Route::controller(BrandController::class)->group(function () {
            ...
            Route::post('update_brand/{brand}', 'update')->name('update_brand');
            Route::get('get_single_brand/{brand}', 'get_single_brand')->name('get_single_brand');
            Route::delete('delete_brand/{brand}', 'delete')->name('delete_brand');
            Route::get('trash_brand', 'trash_brand')->name('trash_brand');
            Route::get('trash_brand_restore/{brand}', 'trash_brand_restore')->name('trash_brand_restore');
            Route::delete('trash_brand_delete/{brand}', 'trash_brand_delete')->name('trash_brand_delete');
            ...
            Route::get('assigned_brand_products/{brand}', 'assigned_products')->name('assigned_brand_products');
            Route::get('unassigned_brand_products', 'unassigned_products')->name('unassigned_brand_products');
        ...
        Route::controller(CategoryController::class)->group(function () {
            ...
            Route::post('update_category/{category}', 'update')->name('update_category');
            Route::get('get_single_category/{category}', 'get_single_category')->name('get_single_category');
            Route::delete('delete_category/{category}', 'delete')->name('delete_category');
            Route::get('trash_categories', 'trash_categories')->name('trash_categories');
            Route::get('trash_restore/{category}', 'trash_restore')->name('trash_restore');
            Route::delete('trash_delete/{category}', 'trash_delete')->name('trash_delete');
            ...
            Route::put('category_status_update/{category}', 'statusUpdate')->name('category_status_update');
        });
        ...
        Route::controller(IntroScreenController::class)->group(function () {
            ...
            Route::post('update_intro_screen/{introScreen}', 'update')->name('update_intro_screen');
            Route::get('get_single_intro_screen/{introScreen}', 'get_single_intro_screen')->name('get_single_intro_screen');
            Route::delete('delete_intro_screen/{introScreen}', 'delete')->name('delete_intro_screen');
            Route::get('trash_intro_screen', 'trash_intro_screen')->name('trash_intro_screen');
            Route::get('trash_intro_screen_restore/{introScreen}', 'trash_intro_screen_restore')->name('trash_intro_screen_restore');
            Route::delete('trash_intro_screen_delete/{introScreen}', 'trash_intro_screen_delete')->name('trash_intro_screen_delete');
        ...
        Route::controller(SectionController::class)->group(function () {
            ...
            Route::get('get_single_section/{section}', 'get_single_section')->name('get_single_section');
            Route::post('update_section/{section}', 'update_section')->name('update_section');
            Route::delete('delete_section/{section}', 'delete')->name('delete_section');
            Route::get('trash_section', 'trash_section')->name('trash_section');
            Route::get('trash_restore_section/{section}', 'trash_restore_section')->name('trash_restore_section');
            Route::delete('trash_delete_section/{section}', 'trash_delete_section')->name('trash_delete_section');
        ...
        Route::controller(SubCategoryController::class)->group(function () {
            ...
            Route::post('update_subcategory/{subcategory}', 'update')->name('update_subcategory');
            Route::get('get_single_subcategory/{subcategory}', 'get_single_subcategory')->name('get_single_subcategory');
            Route::delete('delete_subcategory/{subcategory}', 'delete')->name('delete_subcategory');
            Route::get('trash_subcategory', 'trash_subcategory')->name('trash_subcategory');
            Route::get('trash_subcategory_restore/{subcategory}', 'trash_subcategory_restore')->name('trash_subcategory_restore');
            Route::delete('trash_subcategory_delete/{subcategory}', 'trash_subcategory_delete')->name('trash_subcategory_delete');
            Route::get('all_trash_subcategory_delete', 'all_trash_subcategory_delete')->name('all_trash_subcategory_delete');

            Route::put('sub_category_status_update/{subcategory}', 'statusUpdate')->name('sub_category_status_update');
        });

        Route::controller(ProductController::class)->group(function () {
            Route::get('products', 'products')->name('products');
            Route::post('product_store', 'store')->name('product_store');
            Route::post('update_product/{product}', 'update')->name('update_product');
            Route::get('get_single_product/{product}', 'get_single_product')->name('get_single_product');
            Route::delete('delete_product/{product}', 'delete')->name('delete_product');
            Route::get('trash_products', 'trash_products')->name('trash_products');
            Route::get('trash_product_restore/{product}', 'trash_product_restore')->name('trash_product_restore');
            Route::delete('trash_product_delete/{product}', 'trash_product_delete')->name('trash_product_delete');
            Route::get('all_trash_products_delete', 'all_trash_products_delete')->name('all_trash_products_delete');

            Route::delete('delete_product_variant/{productVariant}', 'delete_product_variant')->name('delete_product_variant');
            Route::delete('delete_product_image/{productImage}', 'delete_product_image')->name('delete_product_image');
            Route::delete('delete_product_variant_image/{ProductVariantImage}', 'delete_product_variant_image')->name('delete_product_variant_image');
            ...
            Route::put('product_status_update/{product}', 'statusUpdate')->name('product_status_update');
        });
        ...
        Route::controller(OfferController::class)->group(function () {
            ...
            Route::get('get_single_offer/{offer}', 'get_single_offer')->name('get_single_offer');
            Route::delete('delete_offer/{offer}', 'delete')->name('delete_offer');
            Route::get('trash_offer', 'trash_offer')->name('trash_offer');
            Route::get('trash_offer_restore/{offer}', 'trash_offer_restore')->name('trash_offer_restore');
            Route::delete('trash_offer_delete/{offer}', 'trash_offer_delete')->name('trash_offer_delete');
            ...
            Route::post('filter_products', 'filterProducts')->name('filter_products');

            Route::get('offer_search', 'search')->name('offer_search');
            Route::put('offer_status_update/{offer}', 'statusUpdate')->name('offer_status_update');
        });
    });
